...
const Experience = () => {
  return (
    <div className="parliamint-experience photo-section">
      <div className="max-width">
        <div className="photo-section-child">
          <div className="photo-section-top">
            <div className="photo-section-heading parliamint-experience-heading">
          ...
          <div className="photo-section-bottom">
            <div className="photo-section-description parliamint-experience-description">
